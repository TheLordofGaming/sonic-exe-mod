...
public class MCreatorRedRing extends Elementssonic_exe_mod.ModElement {
	@GameRegistry.ObjectHolder("sonic_exe_mod:redring")
	public static final Item block = null;

	public MCreatorRedRing(Elementssonic_exe_mod instance) {
		super(instance, 1);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("sonic_exe_mod:redring", "inventory"));
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("redring");
			setRegistryName("redring");
		...
		public EnumActionResult onItemUseFirst(EntityPlayer entity, World world, BlockPos pos, EnumFacing direction, float hitX, float hitY,
			...
			int z = pos.getZ();
			{
				...
				MCreatorRedRingRightClickedOnBlock.executeProcedure($_dependencies);
			}
		...
		public boolean hitEntity(ItemStack itemstack, EntityLivingBase entity, EntityLivingBase entity2) {
			...
			World world = entity.world;
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				$_dependencies.put("entity", entity);
				MCreatorRedRingMobIsHitWithItem.executeProcedure($_dependencies);
			}
			return true;
		}
	}
